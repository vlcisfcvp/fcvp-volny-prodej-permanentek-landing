        ...
        <div ref={ref} className="mx-auto mt-12 grid max-w-pricing gap-4 md:grid-cols-2 md:gap-6 items-stretch">
          ...
          >
            ...
            <div className="mt-auto pt-6">
              <PrimaryButton href="https://bit.ly/4o6hqul" className="w-full">Koupit EXTRA</PrimaryButton>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-auto pt-6">
              <SecondaryButton href="https://bit.ly/43LBokQ" className="w-full">Koupit STANDARD</SecondaryButton>
            </div>
          </motion.div>
        </div>
      </div>
