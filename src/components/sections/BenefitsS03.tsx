...
const items: { icon: LucideIcon; title: string; desc: string }[] = [
  ...
  { icon: Ticket, title: "Přednost na evropské poháry", desc: "Možnost zajistit si vstupenky na evropské zápasy před startem volného prodeje, a navíc se slevou." },
...
export function BenefitsS03() {
  ...
  return (
    <section id="s03" aria-label="Výhody" className="bg-bg-section-alt py-24 md:py-32">
          ...
          {items.map((it, i) => {
            ...
            return (
              <motion.div
                ...
                className="group flex h-full flex-col rounded-lg border border-border-default bg-bg-elevated p-4 md:p-12 md:min-h-[280px] transition-all duration-300 md:hover:-translate-y-1 md:hover:bg-bg-elevated-hover md:hover:border-border-strong"
              >
