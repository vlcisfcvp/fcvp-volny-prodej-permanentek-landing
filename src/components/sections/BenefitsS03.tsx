    ...
    <section id="s03" aria-label="Výhody" className="bg-bg-section py-24 md:py-32">
      <div className="mx-auto max-w-content px-6 md:px-8 lg:px-12">
        <div className="mx-auto max-w-reading text-center">
          ...
          <h2 className="mt-4 t-h2-m md:t-h2-d text-text-primary">V jako Výhody</h2>
          <p className="mt-4 t-body-large-m md:t-body-large-d text-text-secondary">Víc než lístek. Permanentka na celou sezonu zážitků.</p>
        </div>
