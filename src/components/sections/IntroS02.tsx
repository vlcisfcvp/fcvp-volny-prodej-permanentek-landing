...
const paragraphs = [
  "Jste ready?",
  "Vyhrávat se nedá bez boje.",
  "Každý domácí zápas je další bitva, do které jdeme naplno. A stejné je to i na tribunách. Permanentka není jen vstupenka na sezonu. Je to závazek. Být na svém místě. Podporovat Viktorii v každém zápase. Stát za svým týmem, když se vyhrává i když je potřeba fandit až do poslední minuty.",
  ...
  "Buď u toho od první do poslední minuty. Stůj za Viktorkou v každém domácím zápase.",
  "Jste ready?",
