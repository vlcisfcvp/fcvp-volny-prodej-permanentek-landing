  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative z-10 mx-auto max-w-narrow px-6 py-24 text-center">
        ...
        >Tvoje místo. Tvoje sezona. Tvoje Viktorka.</motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.7, delay: 0.24 }}
          className="mt-4 t-body-large-m md:t-body-large-d text-text-secondary"
        >Nečekej. Permanentka má omezený počet kusů.</motion.p>
        <motion.div
          initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
